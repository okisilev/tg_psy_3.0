...
<b>Добро пожаловать в бот клуба «Пробуждение»</b>

То, что мы имеем определяет наше состояние. <b>СОСТОЯНИЕ</b> первично ☝🏻
...
<b>Женский КЛУБ</b>  направлен на изменение состояния в легкое и расслабленное 🧚🏻‍♀️ 
